 ...
 *
 * <ul>
 *   <li><b>Adapter</b> — adapting legacy API via functional interface
 *   <li><b>Decorator</b> — composable decorators via {@link UnaryOperator}
 *   <li><b>Proxy</b> — dynamic proxy for logging/caching
 *   <li><b>Composite</b> — sealed interface tree
 *   <li><b>Facade</b> — simplified API over complex subsystem
 * </ul>
 */

 ...
 *
 * <ul>
 *   <li><b>Strategy</b> — functional interfaces as strategies
 *   <li><b>Observer</b> — type-safe event bus
 *   <li><b>Command</b> — undoable command with sealed interface
 *   <li><b>Template Method</b> — abstract class with hook methods
 *   <li><b>Chain of Responsibility</b> — composable handler pipeline
 * </ul>
 */
@SuppressWarnings({
...
public final class BehavioralPatterns {
  ...
  /**
   * Strategy for computing order totals. Implementations are composable via {@link
   * #withSurcharge(double)}.
   */
  @FunctionalInterface
  ...
  public static final class CsvExporter extends DataExporter<String[]> {
    ...
    @Override
    protected String formatItem(String[] row) {

...
/**
 * Demonstrates JUnit 5 features: lifecycle, nested tests, parameterized tests, dynamic tests,
 * assertions, assumptions, conditional execution, and timeouts.
 */
...
class JUnit5FeaturesTest {
  ...
  void invalidEmails(String email) {
    assertThatThrownBy(() -> new User("Test", email)).isInstanceOf(IllegalArgumentException.class);
  }

  @ParameterizedTest
  @CsvSource({"Alice, alice@example.com", "Bob,   bob@test.org"})
  ...
  static Stream<Arguments> userProvider() {
    return Stream.of(
        Arguments.of("Alice", "alice@example.com"), Arguments.of("Bob", "bob@test.org"));
  }

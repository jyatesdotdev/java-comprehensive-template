...
/**
 * ArchUnit tests enforce architectural constraints at compile time. These run as regular unit tests
 * and fail the build if rules are violated.
 */
@AnalyzeClasses(
...
class ArchitectureRulesTest {
  ...
  static final ArchRule no_cycles_between_packages =
      slices().matching("com.example.template.testing.(*)..").should().beFreeOfCycles();

 ...
 *
 * <ol>
 *   <li>Measure first — never optimize without profiling data
 *   <li>Prefer primitives over boxed types in hot paths
 *   <li>Minimize allocations in tight loops
 *   <li>Use StringBuilder for string concatenation in loops
 *   <li>Choose the right data structure (ArrayList vs LinkedList, HashMap capacity)
 *   <li>Leverage JIT: keep hot methods small, avoid megamorphic call sites
 * </ol>
 */
...
public class PerformanceBenchmarks {
  ...
  public static void main(String[] args) throws Exception {
    var opts = new OptionsBuilder().include(PerformanceBenchmarks.class.getSimpleName()).build();
    new Runner(opts).run();
  }
}

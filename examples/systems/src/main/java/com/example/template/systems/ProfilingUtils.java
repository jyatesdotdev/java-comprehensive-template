 ...
 *
 * <ul>
 *   <li><b>JDK Flight Recorder (JFR)</b>: {@code
 *       -XX:StartFlightRecording=filename=rec.jfr,duration=60s}
 *   <li><b>async-profiler</b>: {@code ./asprof -d 30 -f profile.html <pid>}
 *   <li><b>VisualVM / JConsole</b>: GUI-based JMX monitoring
 * </ul>
 *

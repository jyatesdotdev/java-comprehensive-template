 ...
 *
 * <p>Provides a consistent structure for all API error responses, including validation errors.
 *
...
public record ErrorResponse(
  ...
  /** Defensively copies {@code details} so the record cannot alias a caller's mutable list. */

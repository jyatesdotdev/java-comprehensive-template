 ...
 *
 * <ul>
 *   <li>Standard HTTP method mapping (GET, POST, PUT, DELETE)
 *   <li>Request validation with {@code @Valid}
 *   <li>Proper HTTP status codes (201 Created with Location header, 204 No Content)
 *   <li>DTO separation — controllers never expose domain entities
 *   <li>OpenAPI annotations for Swagger UI documentation
 * </ul>
 */
@RestController

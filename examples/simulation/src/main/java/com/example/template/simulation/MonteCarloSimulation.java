 ...
 *
 * <p>Runs N independent trials of a stochastic experiment and aggregates results. Supports both
...
public final class MonteCarloSimulation {
  ...
  /**
   * Pi estimation: returns 4.0 if random point falls inside unit circle, else 0.0. Mean converges
   * to π.
   *
   ...
   *
   * <p>Uses geometric Brownian motion to simulate the stock price at expiry, then computes the
   * discounted payoff.
   *
   ...
   */
  public static DoubleSupplier europeanCallTrial(
      double spot, double strike, double riskFree, double volatility, double timeToExp) {
